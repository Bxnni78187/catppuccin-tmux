...
main() {
  ...
  local show_window
  readonly show_window="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=$thm_bg,bg=$thm_pink,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_gray] #W #{?client_prefix,#[fg=$thm_red],}#[fg=$thm_gray, bg=$thm_bg]$left_separator"

  local show_session
  readonly show_session="#[fg=$thm_green]#[bg=$thm_bg]$right_separator#{?client_prefix,#[bg=$thm_red],#[bg=$thm_green]}#[fg=$thm_bg] #[fg=$thm_fg,bg=$thm_gray] #S #[fg=$thm_gray, bg=$thm_bg]$left_separator"
